(function () {
  ...
  const kk = {
    "Панель управления":"Басқару панелі","Вход в личный кабинет":"Жеке кабинетке кіру","Логин":"Логин","Пароль":"Құпиясөз","Войти":"Кіру","Администратор":"Администратор","Выйти":"Шығу",
    "Разделы личного кабинета":"Жеке кабинет бөлімдері","Общие":"Жалпы","Достижения":"Жетістіктер","Рейтинг":"Рейтинг","Публикации":"Жарияланымдар","Дни рождения":"Туған күндер","Настройки":"Баптаулар",
    "ТВ-экран":"ТД-экран","Открыть экран":"Экранды ашу","Копировать ссылку":"Сілтемені көшіру","Логотип ТВ-экрана":"ТД-экран логотипі","Логотип по центру экрана":"Экран ортасындағы логотип","Загрузите изображение в формате PNG.":"PNG форматындағы суретті жүктеңіз.","Загрузить PNG":"PNG жүктеу","Вернуть стандартный":"Стандартты логотипті қайтару","Логотип загружен":"Логотип жүктелді","Стандартный логотип восстановлен":"Стандартты логотип қалпына келтірілді","Выберите изображение в формате PNG":"PNG форматындағы суретті таңдаңыз","Размер PNG не должен превышать 8 МБ":"PNG көлемі 8 МБ-тан аспауы керек","Загружаем логотип...":"Логотип жүктелуде...","Восстанавливаем стандартный логотип...":"Стандартты логотип қалпына келтірілуде...","Расписание смен":"Ауысым кестесі","Настроить":"Баптау","Скрыть":"Жасыру",
    ...
    "Содержимое ТВ-экрана":"ТД-экран мазмұны","Показ на ТВ":"ТД-экранда көрсету","Показ объявлений на ТВ":"Хабарландыруларды ТД-экранда көрсету","Показ событий на ТВ":"Іс-шараларды ТД-экранда көрсету","Публикации на ТВ-экране":"ТД-экрандағы жарияланымдар","Дни рождения на ТВ-экране":"ТД-экрандағы туған күндер","Рейтинг на ТВ-экране":"ТД-экрандағы рейтинг","Показывать":"Көрсету","Показывать дни рождения":"Туған күндерді көрсету","Показывать рейтинг учеников":"Оқушылар рейтингін көрсету","Объявления":"Хабарландырулар","События":"Іс-шаралар","Рейтинг учеников":"Оқушылар рейтингі","Сохранить":"Сақтау",
    "Начисление баллов":"Ұпай есептеу","Уровень":"Деңгей","1 место":"1 орын","или абсолютный чемпион":"немесе абсолютті чемпион","2 место":"2 орын","3 место":"3 орын","Номинация":"Номинация","или грамота":"немесе грамота","Сертификат":"Сертификат","Школьный этап":"Мектеп кезеңі","Районный этап":"Аудандық кезең","Городской этап":"Қалалық кезең","Республиканский этап":"Республикалық кезең","Международный этап":"Халықаралық кезең","Сохранить баллы":"Ұпайларды сақтау","Сохранить классы и смены":"Сыныптар мен ауысымдарды сақтау",
    "Поля достижений":"Жетістік өрістері","Обязательные поля всегда отображаются. Остальные можно скрыть из формы.":"Міндетті өрістер әрдайым көрсетіледі. Қалғандарын формадан жасыруға болады.","Обязательно":"Міндетті","Мероприятие":"Іс-шара","Сохраните изменения":"Өзгерістерді сақтаңыз","Настройки полей сохранены":"Өріс баптаулары сақталды","Параметры рейтинга":"Рейтинг параметрлері","Период рейтинга":"Рейтинг кезеңі","Текущая неделя":"Ағымдағы апта","Текущий месяц":"Ағымдағы ай","Текущая четверть":"Ағымдағы тоқсан","Текущий учебный год":"Ағымдағы оқу жылы","За всё время":"Барлық уақыт","Показывать рейтинг":"Рейтингті көрсету","Общий по школе":"Мектеп бойынша жалпы","По сменам":"Ауысымдар бойынша","По параллелям":"Параллельдер бойынша","По классам":"Сыныптар бойынша","Классы и смены":"Сыныптар мен ауысымдар","Не назначена":"Тағайындалмаған","Общий рейтинг школы":"Мектептің жалпы рейтингі","Смены на ТВ":"ТД-дағы ауысымдар","Параллели на ТВ":"ТД-дағы параллельдер","Классы на ТВ":"ТД-дағы сыныптар","Укажите смену для классов":"Сыныптардың ауысымын таңдаңыз","Сохранить настройки рейтинга":"Рейтинг баптауларын сақтау","Есть несохранённые изменения":"Сақталмаған өзгерістер бар","Список классов изменился · сохраните настройки рейтинга":"Сыныптар тізімі өзгерді · рейтинг баптауларын сақтаңыз","Сохранено · проверяем ТВ":"Сақталды · ТД тексерілуде","Сохранено · показ рейтинга на ТВ выключен":"Сақталды · ТД-да рейтинг көрсетілмейді","Сохранено · ТВ-экран ещё не создан":"Сақталды · ТД-экран әлі жасалмаған","Сохранено · для выбранных групп пока нет учеников с баллами":"Сақталды · таңдалған топтарда ұпайы бар оқушылар жоқ","Сохранено, но ТВ-рейтинг не удалось проверить":"Сақталды, бірақ ТД рейтингін тексеру мүмкін болмады","Не сохранено":"Сақталмады",
  ...
  function translatePhrase(value) {
    ...
    return text.replace(/^Показано записей: (\d+) из (\d+)$/, "Көрсетілген жазбалар: $1 / $2").replace(/^Учеников с баллами: (\d+)$/, "Ұпайы бар оқушылар: $1").replace(/^Загружено записей: (\d+)$/, "Жүктелген жазбалар: $1").replace(/^(\d+) из (\d+) назначены · нужно для рейтинга по сменам$/, "$1 / $2 тағайындалды · ауысымдар рейтингі үшін қажет").replace(/^Сохранено · ТВ получает (\d+) записей рейтинга$/, "Сақталды · ТД рейтингтің $1 жазбасын алды").replace(/^(\d+) параллель$/, "$1 параллель").replace(/^Ошибка: /, "Қате: ").replace(/^Удалить запись: /, "Жазбаны жою: ").replace(/^Удалить это достижение\?$/, "Бұл жетістікті жою керек пе?");
  }
