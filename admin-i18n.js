(function () {
  ...
  const kk = {
    ...
    "Содержимое ТВ-экрана":"ТД-экран мазмұны","Показ на ТВ":"ТД-экранда көрсету","Публикации на ТВ-экране":"ТД-экрандағы жарияланымдар","Дни рождения на ТВ-экране":"ТД-экрандағы туған күндер","Рейтинг на ТВ-экране":"ТД-экрандағы рейтинг","Показывать":"Көрсету","Показывать дни рождения":"Туған күндерді көрсету","Показывать рейтинг учеников":"Оқушылар рейтингін көрсету","Объявления":"Хабарландырулар","События":"Іс-шаралар","Рейтинг учеников":"Оқушылар рейтингі","Сохранить":"Сақтау",
